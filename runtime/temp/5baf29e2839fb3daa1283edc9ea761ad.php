<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"E:\test\blog\public/../application/index\view\index\register.html";i:1510486078;s:63:"E:\test\blog\public/../application/index\view\Index\footer.html";i:1510476086;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div style='text-align:center;height:762px;padding:10px;font-size:17px;'>
    ...
    <form accept-charset="UTF-8" action="register/register" method='post'>
        <table style='margin:0 auto;border-width:0px;' border='1' cellspacing='0' cellpadding='5px;'>
            <tr>
                <td><span>*</span>Username:</td><td colspan='3'><input type='text' name='user_name' value=''></td>
            </tr>
            <tr><td><span>*</span>Password:</td><td colspan='3'><input type='password' name='password'></td></tr>
            <tr>
                <td><span>*</span>Name:</td><td><input type='text' name='nickname' value=''></td><td>QQ:</td><td><input type='text' name='qq' value=''></td>
            </tr>
            <tr>
