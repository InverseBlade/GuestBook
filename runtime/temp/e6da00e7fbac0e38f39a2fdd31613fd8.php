<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"E:\GuestBook\public/../application/admin\view\index\message_top.html";i:1510916401;s:63:"E:\GuestBook\public/../application/admin\view\index\header.html";i:1510929451;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <title>后台管理</title>
...
<div>
    <table style="font-size:18px;border-collapse: collapse;border: 1px solid #337ab7;word-break:break-all; word-wrap:break-all;" border="1">
        ...
        <tr>
            ...
            <td style="text-align: center;">
                <a style="color:#337ab7;text-decoration: none" href="/admin_message_top/1/<?php echo $row['id']; ?>">置顶</a> <span style="color: black">|</span>
                <a style="color:#337ab7;text-decoration: none" href="/admin_message_top/2/<?php echo $row['id']; ?>">取消置顶</a>
            </td>
        </tr>
